	...
	// conventional operations
		/*
			...
			return value:
				dot product u^T*v
		*/	
double fsnav_linal_dot(double* u, double* v, const size_t n)
{
	double res;
	size_t i;
	...
	return res;
		...
		*/
double fsnav_linal_vnorm(double* u, const size_t n)
{
	return sqrt(fsnav_linal_dot(u, u, n));
}
		...
		/*
			...
			output:
				size_t* k --- pointer to an index in one-dimensional array,
				              k = 0,1,...,[n*(n+1)/2]-1
		*/
void fsnav_linal_u_ij2k(size_t* k, const size_t i, const size_t j, const size_t n)
{
	*k = i*(2*n - 1 - i)/2 + j;
}
		...
		*/
void fsnav_linal_u_k2ij(size_t* i, size_t* j, const size_t k, const size_t n)
{
		...
		*j = k - (2*n - 1 - i0)*i0/2;
		...
		/*
			...
			input:
				...
				const size_t n --- dimension
		*/
void fsnav_linal_diag2u(double* u, double* d, const size_t n)
{
	size_t i, k;
	...
	for (j = 0; j < m; j++) {
		...
		/*
			...
			note:
				overwriting input (double* res = double* v) is allowed
		*/
void fsnav_linal_uT_mul(double* res, double* u, double* v, const size_t n, const size_t m)
{
		...
		/* 
			...
			output:
				double* res       --- pointer to an upper-triangular n x n matrix
				                      ...
				                      res = v*v^T
		*/
void fsnav_linal_msq2T_u(double* res, double* v, const size_t n, const size_t m)
{
...
void fsnav_linal_msq1T_u(double* res, double* v, const size_t m, const size_t n)
{
	...
	for (j = 0, j1 = 0, k = 0; j < n; j++)
		...
		*/
void fsnav_linal_u_inv(double* res, double* u, const size_t n)
{
...
void fsnav_linal_uuT(double* res, double* u, const size_t n)
{
	...
	for (i = 0, k = 0; i < n; i++) {
		...
		*/
void fsnav_linal_chol(double* S, double* P, const size_t n)
{
